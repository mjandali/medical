...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">{{ __('Patient Account Bewerken') }}</div>

                <div class="card-body">
                    <form action="/patient/update/{{ $user->id }}" method="POST">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="form-group row">
                            <label for="is_employee" class="col-md-4 col-form-label text-md-right">{{ __('Type') }}</label>

                            <div class="col-md-6">
                                <select name="is_employee" id="is_employee" class="form-control">
                                    <option value="0">Patient</option>
                                    <option value="1">Arts/Assistente</option>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                ...
                                <input id="password" type="hidden" class="form-control @error('password') is-invalid @enderror" name="old_password" value="{{ $user->password }}">
