            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="/profile/update/{{ Auth::user()->id }}">
                        ...
                        <div class="form-group row">
                            <label for="birthday" class="col-md-4 col-form-label text-md-right">{{ __('Gebuurtedatum') }}</label>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="phone_number" type="number" class="form-control @error('phone_number') is-invalid @enderror" name="phone_number" value="{{ Auth::user()->phone_number }}" required autocomplete="phone_number" autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                ...
                                <input id="password" type="hidden" class="form-control @error('password') is-invalid @enderror" name="old_password" value="{{ Auth::user()->password }}">
